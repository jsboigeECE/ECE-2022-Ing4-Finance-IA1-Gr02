...
namespace Sudoku.GeneticSharpsSolver
{
    ...
    public class SudokuPermutationsChromosome : SudokuChromosomeBase, ISudokuChromosome
    {
        ...
        public SudokuPermutationsChromosome(GridSudoku targetGridSudoku, Dictionary<int, List<int>> extendedMask) : this(targetGridSudoku, extendedMask, 9) {}

        /// <param name="targetGridSudoku">the target sudoku to solve</param>
        /// <param name="extendedMask">The cell domains after initial constraint propagation</param>
        /// <param name="length">The number of genes for the sudoku chromosome</param>
        public SudokuPermutationsChromosome(GridSudoku targetGridSudoku, Dictionary<int, List<int>> extendedMask, int length) : base(targetGridSudoku, extendedMask, length) { }
        ...
        public override IList<GridSudoku> GetSudokus()
        {
            ...
            var sudoku = new GridSudoku(listInt);
