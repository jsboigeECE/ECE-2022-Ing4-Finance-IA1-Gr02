...
namespace Sudoku.DancingLinksSolvers{
    public class DancingLinksSolversBase : ISolverSudoku{
        ...
        protected Shared.GridSudoku DancingLinksSolverBetter(Shared.GridSudoku instance){
    ...
    public class DancingLinksSolversBetter : DancingLinksSolverBase
    {
